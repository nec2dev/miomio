    ...
    <footer className="p-4 sm:p-6">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href="https://flowbite.com/" className="mr-3 h-8">
          <img className="h-9" src={ Logo }alt="logo MioMio" /> 
      ...
      <div className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8"></div>
