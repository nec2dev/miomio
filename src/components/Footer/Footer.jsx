...
export default function Footer() {
  return (
    <footer className="text-center bg-slate-800 text-white">
      <div className="container px-6 pt-6">
        ...
        <div>
          <form action="">
            <div className="md:grid-cols-3 gird-cols-1 gap-4 justify-center items-center">
      ...
      <div className="text-center p-4 bg-slate-900">
        © 2022 Copyright:
        <Link className="text-white" to="https://nec2solutions.com/">nec2.solutions</Link>
      </div>
    </footer>
  );
}